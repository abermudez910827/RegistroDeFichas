...
def convenio_index(request):
    ...
    return render(request, 'registro_app/convenio/index.html', {'convenios': convenios, 'active_convenios': True ,'active_datos':True})
...
def qse_index(request):
    ...
    paginator = Paginator(qses, 25) # Show 25 per page.
    ...
    return render(request, 'registro_app/qse/index.html', {'qses': page_obj, 'active_qses': True})
