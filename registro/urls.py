...
urlpatterns = [
    ...
    path('personas/edit/<int:persona_id>',
         views.persona_edit, name='persona_edit'),
    path('personas/delete/<int:persona_id>',
         views.persona_delete, name='persona_delete'),
    # Especialidades
    ...
    path('especialidades/<int:especialidad_id>',
         views.especialidad_view, name='especialidad_view'),
    path('especialidades/edit/<int:especialidad_id>',
         views.especialidad_edit, name='especialidad_edit'),
    path('especialidades/delete/<int:especialidad_id>',
         views.especialidad_delete, name='especialidad_delete'),
    # Actividades
    ...
    path('actividades/<int:actividad_id>',
         views.actividad_view, name='actividad_view'),
    path('actividades/edit/<int:actividad_id>',
         views.actividad_edit, name='actividad_edit'),
    path('actividades/delete/<int:actividad_id>',
         views.actividad_delete, name='actividad_delete'),
    # Obra
    ...
    path('objetos/delete/<int:objeto_id>',
         views.objeto_delete, name='objeto_delete'),
    ...
    path('brigadas/edit/<int:brigada_id>',
         views.brigada_edit, name='brigada_edit'),
    path('brigadas/delete/<int:brigada_id>',
         views.brigada_delete, name='brigada_delete'),
    # Convenios
#     path('convenios/', views.convenio_index, name = 'convenios'),
    url(r'^convenios/$', views.convenio_index, name='convenios'),
    path('convenios/nueva', views.convenio_new, name='convenio_new'),
    path('convenios/<int:convenio_id>',
         views.convenio_view, name='convenio_view'),
    path('convenios/edit/<int:convenio_id>',
         views.convenio_edit, name='convenio_edit'),
    path('convenios/delete/<int:convenio_id>',
         views.convenio_delete, name='convenio_delete'),
    # Subir Excel
    path('convenios/uploadexcel', views.upload_excel, name='upload_excel'),
    ...
    path('mes_en_cursos/<int:mes_en_curso_id>',
         views.mes_en_curso_view, name='mes_en_curso_view'),
    path('mes_en_cursos/edit/<int:mes_en_curso_id>',
         views.mes_en_curso_edit, name='mes_en_curso_edit'),
    path('mes_en_cursos/delete/<int:mes_en_curso_id>',
         views.mes_en_curso_delete, name='mes_en_curso_delete'),
    # QSE
#     path('qses/', views.qse_index, name='qses'),
    url(r'^qses/$', views.qse_index, name='qses'),
